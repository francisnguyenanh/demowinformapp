...
# Dictionary to store SEQ_F and row numbers for each sheet
seq_f_per_sheet_dict = {}  # {sheet_index: {row_number: seq_f}}

# Dictionary to store SEQ_CSV and row numbers for each sheet
seq_csv_per_sheet_dict = {}  # {sheet_index: {row_number: seq_csv}}
...
def process_all_tables_in_sequence(excel_file, table_info_file, output_file='insert_all.sql'):
    ...
    """
    global seq_per_sheet_dict, seq_k_per_sheet_dict, seq_f_per_sheet_dict, seq_csv_per_sheet_dict
...
def process_func_data_for_single_sheet(
    ...
    insert_statements = []
    seq_f_counter = 1
    seq_f_per_sheet_dict[sheet_idx] = {}
    current_seq_f = None
            ...
            for check_row in range(row_num + 1, ws.max_row + 1):
                ...
                if merged_bc:
                    ...
                    if cell_b_val and cell_b_val != '画面' and cell_b_val != '番号':
                        ...
                        seq_f_per_sheet_dict[sheet_idx][check_row] = current_seq_f
...
def process_csv_data_for_single_sheet(
    ...
    insert_statements = []
    seq_csv_counter = 1
    seq_csv_per_sheet_dict[sheet_idx] = {}
            ...
            for check_row in range(row_num + 1, ws.max_row + 1):
                ...
                if merged_bc:
                    ...
                    if cell_b_val and cell_b_val != '画面' and cell_b_val != '番号':
                        ...
                        seq_csv_per_sheet_dict[sheet_idx][check_row] = current_seq_csv
